...
export interface SignatureCoder<Y extends config.Config = config.Config, T extends Signature<Y> = Signature<Y>, Z extends UnrecoveredSignature = UnrecoveredSignature> {
...
export declare function subdigestOf(payload: SignedPayload): string;
export declare function isSignedPayload(payload: any): payload is SignedPayload;
