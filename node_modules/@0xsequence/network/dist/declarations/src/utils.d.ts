import { ChainIdLike } from "./index.js";
...
export declare const maybeChainId: (chainId?: ChainIdLike) => number | undefined;
...
export declare const validateAndSortNetworks: (networks: NetworkConfig[]) => NetworkConfig[];
...
export declare const stringTemplate: (sTemplate: string, mData: any) => string;
